...
namespace Meta
{
    ...
    [AddComponentMenu("Meta/Interaction/defaultColorHueGrabInteraction")]
    public class defaultColorHueGrab : Interaction
    {
        ...
        string defaultRequest = "{\"hue\":9000,\"sat\":50}";
        [SerializeField]
        ...
        protected override void Engage()
        {
            ...
            SetHandOffsets();
            UnityWebRequest www = UnityWebRequest.Put(url, defaultRequest);
